  ...
  //POST TYPE: Murspis///////////////////////////////////////////////////////////////////
   ...
   function sektioner_post_type() {
       ...
       $args = array(
            ...
            * https://developer.wordpress.org/resource/dashicons
            */
           'menu_icon'           => 'dashicons-editor-kitchensink', // string (defaults to use the post icon)
            ...
            * set this to a string to control the exact name of the archive slug. (site.com/projects)
            */
           'has_archive'         => 'sektioner', // bool|string (defaults to FALSE)

           /**
            * Sets the query_var key for this post type. If set to TRUE, the post type name will be used.
            * You can also set this to a custom string to control the exact key.
            */
           'query_var'           => 'sektion', // bool|string (defaults to TRUE - post type name)
            ...
            * 'post_updated_messages' hook to customize those.
            */
          'taxonomies'            => array( /*'category', ' tag'*/ 'sektion' ),
           'labels' => array(
               'name'               => __( 'Sektion',                   'sektion-textdomain' ),
               'singular_name'      => __( 'Sektion',                    'sektion-textdomain' ),
               'menu_name'          => __( 'Sektioner',                   'sektion-textdomain' ),
               'name_admin_bar'     => __( 'Sektioner',                   'sektion-textdomain' ),
               'add_new'            => __( 'Lägg till ny',                    'sektion-textdomain' ),
               'add_new_item'       => __( 'Lägg till ny sektion',            'sektion-textdomain' ),
               'edit_item'          => __( 'Redigera sektion',               'sektion-textdomain' ),
               'new_item'           => __( 'Ny sektion',                'sektion-textdomain' ),
               'view_item'          => __( 'Se sektion',               'sektion-textdomain' ),
               'search_items'       => __( 'Sök sektioner',            'sektion-textdomain' ),
               'not_found'          => __( 'Hittade inga sektioner',          'sektion-textdomain' ),
               'not_found_in_trash' => __( 'Hittade inga sektioner i papperskorgen', 'murspis-textdomain' ),
               'all_items'          => __( 'Alla sektioner',               'sektion-textdomain' ),
           )
       );

       /* Register the post type. */
       register_post_type(
           'Sektion', // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
           $args      // Arguments for post type.
       );
   }

   /* Register custom post types on the 'init' hook. */
   add_action( 'init', 'sektioner_post_type' );
